...
* 趣味垢兼用アカウント、頻繁なCC・シャッフルアカウント、病みアカウント、R対応アカウント（会話目的であれば可）など。特に、崩壊勢やネタ勢、キャラの名前を借りただけで一般同然のアカウントはお断り。
...
* 原作の台詞などをBotで繰り返し流すことによる、演技の扮飾あるいはツイート数稼ぎ。
* 他作絵の無断転載・使用。原作の画像はかろうじてグレーゾーン。
* 自作絵や背後に関係した写真などの披露、ゲームの進行状況やガチャ結果などの報告や自慢、公式関係の宣伝、放映やイベントなどの実況、ツイキャス、人狼ゲームなどの、RPとはまったく関係のない行為。
...
　Twitter、並びに同人サークル傘下の専用フォーラムでの、PBT / PBFグループメンバーを随時募集。ジャンルは「魔法少女まどか☆マギカ」本編。作品の内容や公式設定について知悉していて、常に真面目かつ真剣に取り組むことができ、リレーSS形式でのやり取りにもついていけるだけの最低限のスキル（文章力、語彙力、発想力、構成力など）を持ち合わせていることが条件。キャラの重複は不可、掛け持ちは可。詳細についてはDMで。
